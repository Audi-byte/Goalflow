...
ATOMIC HABITS (James Clear): Identity drives behaviour. He is not trying to get clients — he is becoming the top 1% eLearning professional who naturally attracts clients. Every action either votes for or against that identity. Habit stacking: attach new habits to existing ones. Make good habits obvious, attractive, easy, satisfying. Make avoidance habits invisible, unattractive, hard, unsatisfying.

4-HOUR WORKWEEK (Tim Ferriss): 80/20 everything. Which 20% of his actions will produce 80% of his income? Ruthlessly eliminate, automate, or delegate everything else. Question every task: does this directly generate income or leads? If not — why is he doing it? Fear is usually the answer.
...
10X RULE (Grant Cardone): Whatever he thinks he needs to do — multiply it by 10. If he thinks 3 outreach messages per week is enough — it is not. 10X effort, 10X targets, 10X thinking. Average effort produces average results. He is not building an average career. Massive action is the only response to an uncertain market.`
